    ...
    return (
        <>
            <div className='relative h-[1999px]'>
                ...
                <div style={{ top: -78.5-scrollVal * 1.7 }} className='z-[90] absolute opacity-5 right-44 transition-opacity duration-500 hover:opacity-100'>
                    <TwitterEmbed></TwitterEmbed>
                </div>


                <div className="absolute z-[70] w-full"
                    style={{ top: -400 - scrollVal * 2.1, left: -45 + scrollVal*0.12 }}
                >
                ...
                <div className="absolute right-0 z-50 w-full"
                    style={{ top: -625 - scrollVal * 1.7, right: 60 + scrollVal*0.12 }}
                >
                    <BeachRight className='min-w-[1800px]'></BeachRight>
                    <div className='z-[60] absolute top-[550px] right-20 transition-opacity duration-500 hover:opacity-0 '>
                        <TwitterEmbed></TwitterEmbed>
                    </div>
                </div>
